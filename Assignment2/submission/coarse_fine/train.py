...
parser.add_argument("--datadir",help="traininig directory")
...
save_dir = os.path.join(save_dir, args.datadir)
...
schedulers = [MultiStepLR(concat_optimizer, milestones=[60, 100], gamma=0.1),
...
for epoch in range(start_epoch, 500):
    ...
    for i, data in enumerate(trainloader):
        ...
        total_loss = rank_loss + concat_loss + partcls_loss
